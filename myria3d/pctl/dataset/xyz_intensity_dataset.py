...
TOY_EPSG = "2154"
TOY_LAS_DATA = "tests/data/toy_dataset_src/862000_6652000.classified_toy_dataset.100mx100m_output_xyz_intensity.las"
TOY_DATASET_HDF5_PATH = "tests/data/xyz_intensity.hdf5"
COLOURS = [] #(no infrared) # ["Red", "Green", "Blue", "Infrared"] 
